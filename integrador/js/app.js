...
const comprarTickets=()=>{
    seccion.innerHTML=`
        <div class="container">
            <div class="row">
                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2 pt-2 mt-3">
                    ...
                    <form>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input id="cantidadEntrada" type="text" class="form-control mb-4" placeholder="Cantidad">
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label for="" class="mb-2">Categoria</label>
                                <select class="form-select mb-4" id="inputState">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <div id="totalCompra" class="alert alert-primary mb-4" role="alert">
                                    Total a pagar: $
                                </div>
                            </div>
                        </div>
